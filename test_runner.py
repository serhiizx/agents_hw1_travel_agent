...
TEST_CASES = [
    {
        ...
        "checks": "Базова робота ReAct-циклу: один tool call і відповідь на його основі.",
    ...
    },
    {
        ...
        "checks": (
            "Чи планує агент послідовність дій: два РІЗНІ інструменти "
            "в межах одного запиту."
        ),
    ...
    },
    {
        ...
        "checks": (
            "Чи використовує агент результати tools для синтезу комплексної поради, "
            "а не просто переказує три Observation'и підряд."
        ),
    ...
    },
    {
        ...
        "checks": (
            "Чи відхиляє Pydantic некоректний параметр і чи обробляє агент помилку "
            "як Observation, замість того щоб впасти або вигадати прогноз."
        ),
        "expected": (
    ...
    },
    {
        ...
        "checks": (
            "Чи дає запобіжник max_steps часткову відповідь із уже зібраними "
            "даними, а не виняток."
        ),
